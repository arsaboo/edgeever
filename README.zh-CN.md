...
将下方提示词复制给已配置 GitHub、Cloudflare MCP、插件或其他可用集成的 AI Agent：
...
详细要求见：[AI Agent 在线部署约定](docs/agent-deploy-cloudflare.zh-CN.md)。

### 方案二：Fork 后在线部署

共 4 步完成部署：[在 GitHub Fork EdgeEver](https://github.com/tianma-if/edgeever/fork)、导入 Cloudflare Workers & Pages、配置所需资源、启动并验证首次构建。详细操作请查看[在线部署文档](docs/deploy-cloudflare-button.zh-CN.md)。
